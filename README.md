...
| Perl |
| Delphi |
| Rust | [`rand::Rng`](https://docs.rs/rand/0.5.0/rand/trait.Rng.html) | [`rand::thread_rng().gen_range(1..=10);`](https://docs.rs/rand/0.5.0/rand/trait.Rng.html#method.gen_range) | [`rand::thread_rng().gen_range(0.0..100.0) as f32;`](https://docs.rs/rand/0.5.0/rand/trait.Rng.html#method.gen_range) |
